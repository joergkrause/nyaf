...
export default store;
            ...
            <hr />
            <h3 class='display-4' id='updates' source='storeupdates'>Effects and Updates</h3>
            <app-slot-tabs>
              <app-slot-tab title='Explanation'>
                <div class='alert alert-info mb-5'>
                  This component uses the <code>@Updates</code> decorator to enforce a better seperation of concern style for the component.
                  All the store actions that are triggerd by user action are now moved outside the component and simplify parameter access.
                </div>
              </app-slot-tab>
              <app-slot-tab title='Playground'>
                <app-store-updates id='s2'></app-store-updates>
              </app-slot-tab>
              <app-slot-tab title='Demo Markup'>
              </app-slot-tab>
              <app-slot-tab title='Source Code'>
          ...
          <div class='col-2' style='position: fixed; right: 15px;'>
            <nav id='demonav'>
              <ul class='nav flex-column'>
                ...
                <li class='nev-item'>
                  <a class='nav-link' href='#updates'>Effects and Updates</a>
                </li>
              </ul>
            </nav>
          </div>
