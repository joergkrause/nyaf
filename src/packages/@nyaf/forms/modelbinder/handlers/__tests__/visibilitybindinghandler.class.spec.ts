...
import { VisibilityBindingHandler } from '../visibilitybindinghandler.class';

test('VisibilityBindingHandler', () => {
  const handler = new VisibilityBindingHandler();
  expect(handler.constructor[Symbol.for('bindingname')]).toEqual('VisibilityBindingHandler');
